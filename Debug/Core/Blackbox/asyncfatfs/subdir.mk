...
Core/Blackbox/asyncfatfs/%.o Core/Blackbox/asyncfatfs/%.su Core/Blackbox/asyncfatfs/%.cyclo: ../Core/Blackbox/asyncfatfs/%.c Core/Blackbox/asyncfatfs/subdir.mk
...
clean-Core-2f-Blackbox-2f-asyncfatfs:
	-$(RM) ./Core/Blackbox/asyncfatfs/asyncfatfs.cyclo ./Core/Blackbox/asyncfatfs/asyncfatfs.d ./Core/Blackbox/asyncfatfs/asyncfatfs.o ./Core/Blackbox/asyncfatfs/asyncfatfs.su ./Core/Blackbox/asyncfatfs/fat_standard.cyclo ./Core/Blackbox/asyncfatfs/fat_standard.d ./Core/Blackbox/asyncfatfs/fat_standard.o ./Core/Blackbox/asyncfatfs/fat_standard.su
