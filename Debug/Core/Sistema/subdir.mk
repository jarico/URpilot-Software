...
Core/Sistema/%.o Core/Sistema/%.su Core/Sistema/%.cyclo: ../Core/Sistema/%.c Core/Sistema/subdir.mk
...
clean-Core-2f-Sistema:
	-$(RM) ./Core/Sistema/system_stm32f7xx.cyclo ./Core/Sistema/system_stm32f7xx.d ./Core/Sistema/system_stm32f7xx.o ./Core/Sistema/system_stm32f7xx.su
